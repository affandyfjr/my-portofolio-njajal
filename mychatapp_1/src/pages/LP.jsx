...
import gambar_2 from "../assets/gambar awal-min.png";
import gambar_3 from "../assets/foto kuning-min.png";
import gambar_4 from "../assets/gambar bawah-min.png";
import {
  IoChatbubbleOutline,
  IoNotifications,
  IoDocumentText,
...
import Komponen_scroll_1 from "../components/Komponen_scroll_1";
  ...
  return (
    <>
      ...
      >
        {/* Section 1 */}
        <motion.div
          className="1 sm:flex sm:relative pt-20"
          initial="hidden"
          whileInView="visible"
        ...
        {/* Section 2 */}
        <motion.div
          className="2 mt-20 md:mt-28 xl:mt-36"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeInFromBottom}
        >
          ...
          <div className="bagian-slide flex flex-col sm:flex-row items-center mt-20 space-y-5 sm:space-y-0 sm:space-x-3 lg:space-x-8 sm:justify-between">
            <Slide_scrool2
              logo={
        ...
        {/* Section 3 */}
        <motion.div
          className="3 mt-20 md:mt-28 xl:mt-36 md:flex md:flex-row xl:justify-between"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeInFromBottom}
        >
          <div className="kiri flex flex-col items-center md:items-start justify-around  space-y-5 md:w-[50%] xl:w-[45%] ">
          ...
          <div className="kanan mt-10 md:mt-0 flex justify-center md:w-[50%] px-5 sm:px-[15vw] md:px-0 lg:pl-7 xl:pl-20">
            <div className="container space-y-5 w-full h-auto bg-yellow-400 p-5 md:p-6  lg:p-7 rounded-xl xl:rounded-2xl content-center">
              <Komp_slider_3
                logo_3={
        ...
        {/* Section 4 */}
        <motion.div
          className="4 mt-20 md:mt-28 xl:mt-36 md:flex md:flex-row-reverse xl:justify-between"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeInFromBottom}
        >
          <div className="kanan flex flex-col items-center md:items-start justify-around  space-y-5 md:w-[50%] xl:w-[45%]">
            <h1 className="text-center md:text-left font-bold text-3xl md:text-4xl xl:text-5xl">
            ...
            <div className="kaki flex justify-between w-full">
          ...
          <div className="kiri mt-10 md:mt-0 flex justify-center md:w-[50%] px-5 sm:px-[15vw] md:px-0 lg:pr-7 xl:pr-20">
      ...
      {/* Section 5 */}
      <motion.div
        className="5 mt-16 md:mt-20 xl:mt-28 flex flex-col items-center bg-blue-200 py-10 lg:py-20 px-10"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.5 }}
        variants={fadeInFromBottom}
